...
class GameRunner:
    def __init__(self):
        ...
        self.run_button = pygame.Rect(WIDTH // 2 - 50, HEIGHT // 2, 100, 40)
        self.stop_button = pygame.Rect(WIDTH // 2 - 50, HEIGHT // 2 + 50, 100, 40)
        self.status_text = ""
    ...
    def draw(self):
        ...
        # Display Number of Games to Run
